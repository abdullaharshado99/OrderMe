                        ...
                        <CardContent>
                            <div className="flex justify-between">
                                ...
                                <div className="text-gray-700">
                                    ...
                                    <p className="font-bold mt-2 text-[var(--raspberry)]">
                                        ...
                                        {nextStatus[order.status as keyof typeof nextStatus] && (
                                            <button
                                                onClick={() =>
                                                    updateStatus(
                                                        order.id,
                                                        { pending: 'confirmed', confirmed: 'cooking', cooking: 'ready', ready: 'delivered' }[order.status as keyof typeof nextStatus]
                                                    )
                                                }
